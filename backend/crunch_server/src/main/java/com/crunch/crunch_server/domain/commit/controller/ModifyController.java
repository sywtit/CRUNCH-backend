...
public class ModifyController {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    void saveFiles(@RequestParam("files") MultipartFile[] files) throws Exception {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    void checkFile(@RequestParam("file") MultipartFile[] files) throws Exception {
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public String checkAccessBefore(@RequestHeader(value = "token") String token, @PathVariable int projectId,
